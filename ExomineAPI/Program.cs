...
{
    new Governor { Id = 1, Name = "Aria Chen", ColonyId = 1, Status = "active" },
    new Governor { Id = 2, Name = "Marcus Webb", ColonyId = 2, Status = "active" },
    new Governor { Id = 3, Name = "Elena Petrov", ColonyId = 3, Status = "inactive" },
    new Governor { Id = 4, Name = "Sam Osei", ColonyId = 1, Status = "active" },
};

List<MiningFacility> miningFacilities = new()
{
    new MiningFacility { Id = 1, Name = "Olympus Mons Extraction", Status = "active" },
    new MiningFacility { Id = 2, Name = "Europa Ice Rig", Status = "active" },
    new MiningFacility { Id = 3, Name = "Deimos Quarry", Status = "inactive" },
};
